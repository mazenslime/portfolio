...
const Work = ({projects}) => {
  ...
  return (
    <div id='work' className='relative min-h-screen bg-gray-900 text-white flex flex-col justify-start items-center'>
        <div className='px-4 py-2  mt-30 h-10 py-2  bg-purple-500/10 rounded-4xl border-1 border-purple-600'>
            My Work
        </div>
        <div>
            <p className='mt-4 text-5xl font-bold text-white-500'>Dig into our universe</p>
        </div>
